...
/*
    ...
    <-------------- CALLBACK TO SHOW EACH ROW IN THE TABLE ------------->
...
void addFaculty(){
    ...
    cout<<"Enter faculty's name "<<setw(17)<<": ";
    getline(cin,name);
    //cin.ignore(numeric_limits<streamsize>::max(),'\n');  // discard buffer
    cout<<"Enter faculty's contact number "<<setw(7)<<": ";
    cin>>phoneNo;
    //cin.ignore(numeric_limits<streamsize>::max(),'\n');  // discard buffer
    cout<<"Class taught by the faculty(1-12) "<<setw(4)<<": ";
    cin>>teachesClass;
    cin.ignore(numeric_limits<streamsize>::max(),'\n');  // discard buffer
    cout<<"Subject taught by the faculty "<<setw(8)<<": ";
    getline(cin,subject);
    //cin.ignore(numeric_limits<streamsize>::max(),'\n');  // discard buffer
    cout<<"Enter salary "<<setw(25)<<": ";
    cin>>salary;
...
/*
    ...
    <-------------- MENU OF THE PROGRAM ------------->
    Makes call to other functions based on user's choice
